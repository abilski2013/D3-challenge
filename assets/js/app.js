...
function renderYCircleLabels(circlesLabels, newYScale, chosenYAxis) {
...
function updateToolTip(chosenXAxis, circlesGroup, chosenYAxis) {
  ...
  var toolTip = d3.tip()
    ...
    .offset([80, -100])
    .html(function(d) {
      return (`${d.state}<br><strong>${label}</strong> ${d[chosenXAxis]}<br><strong>${label2}</strong> ${d[chosenYAxis]}`);
    });
...
function updateToolTip2(chosenXAxis, circlesLabels, chosenYAxis) {
...
d3.csv("assets/data/data.csv").then(function(Data, err) {
  ...
  var circlesLabels = chartGroup.append("g").selectAll("text")
    .data(Data)
    .enter()
    .append("text")
    .text(d => d["abbr"])
  ...
  var circlesLabel = updateToolTip2(chosenXAxis, circlesLabels, chosenYAxis);    
  ...
  labelsGroup.selectAll("text")
    .on("click", function() {
      ...
      if (value !== chosenXAxis) {
        ...
        circlesLabel = updateToolTip2(chosenXAxis, circlesLabels, chosenYAxis);   
  ...
  ylabelsgroup.selectAll("text")
    .on("click", function() {
      ...
      if (value !== chosenYAxis) {
        ...
        circlesLabels = renderYCircleLabels(circlesLabels, yLinearScale, chosenYAxis);
        // updates tooltips with new info
        circlesGroup = updateToolTip(chosenXAxis, circlesGroup, chosenYAxis);
        circlesLabel = updateToolTip2(chosenXAxis, circlesLabels, chosenYAxis); 
        // changes classes to change bold text
